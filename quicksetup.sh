...
sudo apt-get install --assume-yes axel terminator zsh i3 i3status i3lock xbacklight dmenu scrot libcurl3 git pdftk get-iplayer ffmpeg libavcodec-extra-54 audacity gparted python-numpy python-scipy python-matplotlib ipython ipython-notebook python-pandas python-sympy python-nose traceroute curl openjdk-7-jdk mpg123 musescore docx2txt antiword catdoc python-software-properties qgis wine playonlinux winetricks silversearcher-ag exuberant-ctags fonts-inconsolata kexi digiKam tmux testdisk gimp gimp-ufraw clementine texstudio baobab gPodder smartmontools ruby1.9.1-dev libcurl4-openssl-dev vim-gnome youtube-dl build-essential postgresql-9.3 postgresql-server-dev-9.3 libxml2-dev libgdal-dev libproj-dev libjson0-dev xsltproc docbook-xsl docbook-mathml postGIS r-cran-class r-cran-cluster r-cran-codetools r-cran-foreign r-cran-kernsmooth r-cran-lattice r-cran-mass r-cran-matrix r-cran-mgcv r-cran-nlme r-cran-nnet r-cran-rpart r-cran-spatial r-cran-survival r-cran-rodbc littler python-rpy python-rpy-doc yacas virtualbox graphviz libgtk2.0-dev hugin timidity freepats htop terminator virtualbox-4.3 virtualbox-guest-utils virtualbox-guest-x11 virtualbox-guest-dkms virtualbox-guest-additions zsh python-pip r-base r-base-dev libcurl4-openssl-dev libxml2-dev libjpeg62 r-cran-rjava haskell-platform easytag tree acpi 
